    ...
    const response = await axios.post(
      `${GEMINI_API_URL}?key=${GEMINI_API_KEY}`,
      {
        contents: [{ parts: [{ text: `
         ...
         You are an AI that refines and enhances user-provided tech descriptions into a well-structured, concise, and professional sentence between 15 to 30 words (less than 250 characters including space also). Ensure clarity, readability, and a natural flow. Maintain accuracy while making the description sound impressive and engaging.
